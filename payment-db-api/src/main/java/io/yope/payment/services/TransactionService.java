...
public interface TransactionService {
     ...
     * @param direction the direction of the transation - optional
     ...
     */
    List<Transaction> getForWallet(String walletHash, String reference, Direction direction);
     ...
     */
    List<Transaction> getForAccount(Long accountId, String reference, Direction direction);
